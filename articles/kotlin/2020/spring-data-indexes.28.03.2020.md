### Compound Partial Индексы в spring-data-mongodb
...
Решение создать индекс самому

#### Как создать индекс самому

Во-первых надо отключить автосоздание индекса
```yaml
spring:
    data:
      mongodb:
...
* Проверять на существование похожего индекса, если такое есть, то подчищать его или не вставлять новый,
